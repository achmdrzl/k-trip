...
<div class="komen cf">
	<div class="kmn"> 
		<div class="kmna">
			<h1 class="judl">Kami akan senang jika mendengar masukkan dari anda</h1>
			<hr width="100%"> 
			...
			<div class="ktk1">
			<input type="text" name="pesan" placeholder=" Pesan/Masukan/Kritik/Saran" required/>
			</div>
			<input type="button" class="tombol" value="Kirim Pesan"/>
		</div>
	</div>
	...
	<div class="kmn1">
		<div class="maps">
			...
			<a href="#sec" id="btn">Kasuami.team ltd</a>
			<a href="#sec" id="titik"> <img src="../../img/homepage/titik.png"></a>
			
		<a href="https://goo.gl/maps/82uBapPHszWDpNn89" target="_blank"><img src="../../img/homepage/maps.png" alt=""></a>
		<div class="keter">
		<p>Telp. +62 1234 5678 910</p>
		<br>
		<p>Email kasuami.team@gmail.com</p>
		<br>
		<p>Alamat Kendari, Sulawesi Tenggara</p>
		</div>
	</div>
	</div>
